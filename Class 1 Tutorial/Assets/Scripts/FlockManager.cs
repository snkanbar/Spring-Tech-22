...
public class FlockManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < BoidCount; i++) //why give random position range
        {
            ...
            boids[i] = Instantiate(BoidPrefab, pos, Quaternion.identity); //whaa just happened here lol
            boids[i].GetComponent<Boid>().Manager = this; //what is"this" used for?
        }
